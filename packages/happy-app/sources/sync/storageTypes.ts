...
export const MetadataSchema = z.object({
    ...
    initialPermissionMode: z.string().nullish(), // CLI-resolved initial permission mode — kept loose so newer CLIs adding modes don't drop the whole metadata; seeded into session.permissionMode by resolveSessionPermissionMode
